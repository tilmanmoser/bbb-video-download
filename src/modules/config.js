...
parser.add_argument('-w', '--width', { help: 'width of output file', type: 'int', default: 1280 })
parser.add_argument('-h', '--height', { help: 'height of output file', type: 'int', default: 720 })
